...
namespace Game_IfreannCorp.Enemy
{
    ...
    public class Type4 : Entity
    {
        ...
        public Type4(bool _Ambush, Vector2 _PlayerCo)
        {
            _Health = 100;
            _Active = true;
        ...
        public override void LoadContent()
        {
            ...
            _Sprite = Main.Instance.Content.Load<Texture2D>("Corporation/Corp" + _Num1.ToString() + "p1");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            _Sprite = Main.Instance.Content.Load<Texture2D>("Corporation/Corp" + _Num1.ToString() + "p" + _Counter.ToString());
            ...
            if (!_Ambush)
            {
                ...
                if (_Mode == 1)
                {
                    ...
                    {
                        Projectile _Bullet = new Projectile(_Position, _VDirection, 2);
                        _Bullet.LoadContent();

...
namespace Game_IfreannCorp.Menu
{
    ...
    /// </summary>
    public class Loadbutton : Entity
    {
        public Loadbutton(int _X, int _Y)
        {
            this._X = _X;
            this._Y = _Y;
            _Scale = 1.0f;
        ...
        {
            _Sprite = Main.Instance.Content.Load<Texture2D>("Menus/Load");
        ...
        {
            Main.Instance.Spritebatch.Draw(_Sprite, _Position, null, Color.White, 0, _Center, _Scale, SpriteEffects.None, 0);
        }
    }
}
